    ...
    <div class="avatar-upload">
        <Hints>
            ...
            <template slot="hintInfo">
                ...
                <p>地址：访问
                    <el-link type="success" href="https://element.eleme.cn/2.13/#/zh-CN/component/upload"
                             target="_blank">elementUI-upload
                    </el-link>
                </p>
            </template>
        </Hints>
                ...
                <el-card shadow="always" :body-style="{padding: '0px'}">
                    ...
                    <div class="content-box">
                        <el-upload action="https://jsonplaceholder.typicode.com/posts/" :file-list="fileList"
                                   list-type="picture">
                            <el-button size="small" type="primary" class="icon-small"><i class="el-icon-upload"/>点击上传
                            </el-button>
                            <div slot="tip" class="el-upload__tip">只能上传jpg、jpeg、gif、png、bmp文件，且不超过500kb</div>
                        </el-upload>
                    </div>
