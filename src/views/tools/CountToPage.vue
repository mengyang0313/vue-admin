    ...
    <div class="count-to-page">
        <Hints>
            ...
            <template slot="hintInfo">
                ...
                <p>github地址：访问
                    <el-link type="success" href="https://github.com/PanJiaChen/vue-countTo" target="_blank">
                        vue-countTo
                    </el-link>
                </p>
            </template>
                ...
                <el-card shadow="always" :body-style="{padding: '0px'}">
                    ...
                    <div class="cont-wrapper">
                        <div class="cont-set-data">
                            <CountTo ref="countBox" :start-val="startVal" :end-val="endVal" :duration="duration"
                                     :decimals="decimals" :separator="separator" :prefix="prefix" :suffix="suffix"
                                     :autoplay="false"/>
                        </div>
                        <div class="box-cont-set">
                            <div class="cont-set-item">
                                <label>startVal：</label>
                                <el-input v-model="startVal"/>
                            </div>
                            <div class="cont-set-item">
                                <label>endVal：</label>
                                <el-input v-model="endVal"/>
                            </div>
                            <div class="cont-set-item">
