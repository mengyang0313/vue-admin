    ...
    <div class="table-classic-wrapper">
        ...
        <el-card shadow="always">
            ...
            <div class="control-btns">
                <el-button type="primary" @click="testGrpc">测试grpc</el-button>
                <el-button type="primary" @click="testGrpc2">测试grpc2</el-button>
...
import { LoginRequest } from '@/proto/js/cms_grpc_web_pb.js'
...
export default {
    ...
    methods: {
        ...
        //     req.setName("vueName")
        //
        //     greeterClient.sayHello(req, {}, (err, helloReply) => {
        //         if (err) {
        //             console.log(err)
        //         } else {
        //             console.log(helloReply.getMessage())    // {message: "hello tom and city is 合肥"}
        //             console.log(helloReply.getSon().getMessage())
        //         }
        //     })
        // },
        // 测试grpc
        testGrpc2() {
            ...
            loginReq.setEmail("superadmin")
            loginReq.setPassword("123456")

            cmsService.login(loginReq, {}, (err, admin) => {
                if (err) {
                    console.log(err)
                } else {
                    console.log(admin.getEmail())    // {message: "hello tom and city is 合肥"}
                    console.log(admin.getAccessToken())
                    setToken(admin.getAccessToken())
                }
            })
        },
        // 多选操作
