...
// import {GreeterClient} from '@/proto/demo/helloworld_grpc_web_pb.js'
// import {HelloRequest, HelloReply} from '@/proto/demo/helloworld_pb.js'
...
export default {
    ...
    methods: {
        // // 测试grpc
        // testGrpc() {
        //     const greeterClient = new GreeterClient('http://43.132.169.239:10000', null, null)
        //     const req = new HelloRequest()
        //     req.setName("vueName")
        //
        //     var metadata = {'content-type': 'application/grpc-web'};
        //     greeterClient.sayHello(req, {}, (err, response) => {
        //         if (err) {
        //             console.log(err)
        //         } else {
