<template>
    <el-dialog title="处理违规" :visible.sync="dialogVisible" append-to-body width="50%" :before-close="closeDialog">
        <div class="form-list-wrapper">
            <el-form ref="ruleForm" :model="form" :rules="rules" label-width="150px" class="form-list">
                ...
                <el-form-item label="封禁类型" prop="dealStatus">
                    <el-select v-model="form.dealStatus" placeholder="请选择" @change="changeBlockStatus">
                        <el-option
                ...
                <el-form-item label="封禁理由" prop="dealMessage">
                    <el-input
...
export default {
    ...
    methods: {
        init(row){
            this.form.entityId = row.reportedId
        ...
        submitForm() {
            ...
            this.$refs.ruleForm.validate((valid) => {
                if (valid) {
                    this.$service.audit.processViolation(this.form, function (result){
                        if (result) {
