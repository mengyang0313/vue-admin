        ...
        <el-card shadow="always">
            ...
            >
                <template>
                    ...
                    <el-form-item label="主播Id" prop="reportedId">
                        <el-input v-model="search.reportedId" type="number" placeholder="主播Id"/>
                    </el-form-item>
                    <el-form-item label="封禁时间" prop="reportedTime">
            ...
            >
                ...
                <el-table-column label="操作" align="center" width="150" fixed="right">
                    <template slot-scope="scope" >
                        <span v-if="scope.row.revoked" style="padding-right:10px;padding-left:10px;">
                            <el-button type="text" @click="toDialog('block',scope.row)">封禁</el-button>
                        </span>
                        <span v-else>
                            <el-button type="text" @click="unblock(scope.row.reportedId)" style="padding-right:10px;padding-left:10px;">解封</el-button>
                        </span>
                    </template>
                </el-table-column>
            </el-table>
...
import {
    ...
    getViolationScene,
    getViolationType,
    getBlockStatus, getArrName, getAppName, getAppListByAreaId, getCurrentUserAreaId, getBlockTime
} from "@/utils/dist";
...
export default {
    ...
    created() {
        this.search.areaId = this.authAreaId === 0 ? this.areaData[1].value : this.authAreaId
        this.fetchData()
    },
    methods: {
        // 获取数据列表
        ...
        toDialog(component, row){
            ...
            this.$nextTick(()=>{
                this.$refs[component].init(param);
            })
        },
