    ...
    <div class="table-classic-wrapper">
        <el-card shadow="always">
            ...
            <div class="control-btns">
                <el-button type="primary" @click="toDialog('addAreaConfig', '')">+ 新增配置</el-button>
            </div>
            <!-- 查询栏 -->
            <el-form
                ref="searchForm"
            ...
            >
                ...
                <el-table-column label="操作" align="center" width="250" fixed="right">
                    <template slot-scope="scope">
                        <el-button type="text" @click="toDialog('addAreaConfig', scope.row)">参数配置</el-button>
...
export default {
    components: { Pagination, imageShow, addAreaConfig, ossConfig, agoraConfig, rongcloudConfig, greenConfig},
    data() {
        return {
            listLoading: true,
            search: {
