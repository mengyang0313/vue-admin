    ...
    <div class="video-player-wrapper">
        <Hints>
            ...
            <template slot="hintInfo">
                ...
                <p/>
                <p>github地址：访问
                    <el-link type="success" href="https://github.com/surmon-china/vue-video-player" target="_blank">
                        Vue-Video-Player
                    </el-link>
                </p>
            </template>
            ...
            <el-col :span="12">
                <el-card shadow="always">
                    ...
                    <div class="content-box">
                        <video src="https://cdn.jsdelivr.net/gh/baimingxuan/media-store/videos/houlang.mp4" controls
                               width="100%" style="outline: none"/>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="12">
