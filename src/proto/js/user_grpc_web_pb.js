...
/**
 * @param {!proto.pb.user.BindAuthRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
...
proto.pb.user.UserSdkClient.prototype.bindAuth =
  ...
  return this.client_.rpcCall(this.hostname_ +
      ...
      request,
      metadata || {},
      methodDescriptor_UserSdk_BindAuth,
      callback);
};
...
/**
 * @param {!proto.pb.user.UnbindAuthRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
...
proto.pb.user.UserSdkClient.prototype.unbindAuth =
  ...
  return this.client_.rpcCall(this.hostname_ +
      ...
      request,
      metadata || {},
      methodDescriptor_UserSdk_UnbindAuth,
      callback);
};
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.pb.user.AttributionRequest,
 *   !proto.pb.user.AttributionReply>}
 */
const methodDescriptor_UserSdk_ReportAttribution = new grpc.web.MethodDescriptor(
  '/pb.user.UserSdk/ReportAttribution',
  grpc.web.MethodType.UNARY,
  proto.pb.user.AttributionRequest,
  proto.pb.user.AttributionReply,
  /**
   * @param {!proto.pb.user.AttributionRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.pb.user.AttributionReply.deserializeBinary
);
 ...
 *   !proto.pb.user.AttributionReply>}
 */
const methodInfo_UserSdk_ReportAttribution = new grpc.web.AbstractClientBase.MethodInfo(
  proto.pb.user.AttributionReply,
  /**
   * @param {!proto.pb.user.AttributionRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.pb.user.AttributionRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.pb.user.AttributionReply)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.pb.user.AttributionReply>|undefined}
 *     The XHR Node Readable Stream
 */
proto.pb.user.UserSdkClient.prototype.reportAttribution =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/pb.user.UserSdk/ReportAttribution',
      request,
      metadata || {},
      methodDescriptor_UserSdk_ReportAttribution,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.pb.user.AttributionReply>}
 *     Promise that resolves to the response
 */
proto.pb.user.UserSdkPromiseClient.prototype.reportAttribution =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/pb.user.UserSdk/ReportAttribution',
      request,
